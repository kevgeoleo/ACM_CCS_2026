...
function string_literal_handler(filePath,code,value,type){
  ...
  if(value == "__proto__"){
    if(type == "string_literal"){
      var code1 = ast_replacer("string_literal","__proto__","constructor.prototype",code)
      var code2 = ast_replacer("string_literal","__proto__",["'constructor'","'prototype'"],code)
    ...
    var code1 = ast_replacer("string_literal",value,"constructor.prototype." + some_string, code)
    ...
    var code2 = ast_replacer("string_literal",value,`{"constructor.prototype": {"${some_string}":"${some_other_string}"}}`, code)
    createFile(filePath,code1)
    createFile(filePath,code2)
    variant_caller([code1,code2,code],filePath)
    ...
    var code1 = ast_replacer("string_literal",value,`{"${some_string}": {"constructor": {"prototype": {"${some_other_string}":"${another_string}"}}}}`, code)
    var code2 = ast_replacer("string_literal",value,`{"${some_string}": {"constructor.prototype": {"${some_other_string}":"${another_string}"}}}`, code)
    createFile(filePath,code1)
    createFile(filePath,code2)
    variant_caller([code1,code2,code],filePath)
    ...
    var code1 = ast_replacer("string_literal",value,`constructor.prototype[${some_string}]`, code)
    var code2 = ast_replacer("string_literal",value,`constructor[prototype][${some_string}]`, code)
    createFile(filePath,code1)
    createFile(filePath,code2)
    variant_caller([code1,code2,code],filePath)
    ...
    var code1 = ast_replacer("string_literal",value,`[constructor.prototype]\n${some_string}=${some_other_string}`, code)
    var code2 = ast_replacer("string_literal",value,`[constructor][prototype]\n${some_string}=${some_other_string}`, code)
    createFile(filePath,code1)
    createFile(filePath,code2)
    variant_caller([code1,code2,code],filePath)
    ...
    var code1 = ast_replacer("string_literal",value,`${some_string}.constructor.prototype.${some_other_string}`, code)
    createFile(filePath,code1)
    variant_caller([code1,code],filePath)
    ...
    let replacement1 = value.replace("__proto__", "constructor.prototype");

    var code1 = ast_replacer("string_literal",value,replacement1, code)
    createFile(filePath,code1)
    variant_caller([code1,code],filePath)
  }
...
module.exports = string_literal_handler